...
public class AdventureGameView extends GBFrame {
	...
	JButton saveButton = addButton("Save Game", 13, 5, 1, 1);
	JButton loadButton = addButton("Load Game", 12, 5, 1, 1);
	JButton difficButton = addButton("Change Difficulty", 11, 5, 1, 1);
