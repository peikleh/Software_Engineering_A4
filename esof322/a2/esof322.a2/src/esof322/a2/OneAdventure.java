...
public class OneAdventure implements Adventure, java.io.Serializable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see esof322.a2.Adventure#createAdventure(esof322.a2.adventureFactory)
	 */
	@Override
	public Room createAdventure(adventureFactory f) {
		// The outside:
		Room outside = f.createRoom();
		...
		Key theKey = f.createKey();
		theKey.setDesc("A shiny gold key.");
		r6.addItem(theKey);

		Trap theTrap = new Trap();
		theTrap.setDesc("A dangerous looking toad");
		r2.addItem(theTrap);

		Trap theTrap1 = new Trap();
		theTrap1.setDesc("A dangerous looking toad");
		r2.addItem(theTrap1);

		Trap theTrap2 = new Trap();
		theTrap2.setDesc("A dangerous looking toad");
		r2.addItem(theTrap2);

		// We add a door between r10 and r11:
		Door theDoor = f.createDoor(r10, r11, theKey);
